...
Основные алгоритмы сортировки включают Bubble Sort, Selection Sort, Insertion Sort, Merge Sort, Quick Sort и Heap Sort.
...
Обход в глубину (DFS) и обход в ширину (BFS) — это два основных алгоритма для исследования графов. DFS использует стек (рекурсию), а BFS использует очередь. Оба алгоритма имеют временную сложность **O(V + E)**.
